...
class CheckWorkflowContractsTest < Minitest::Test
  ...
  def test_required_syntax_tools_install_rustfmt
    quality = File.read(File.join(ROOT, ".github/workflows/quality.yml"), encoding: "UTF-8")

    assert_includes quality, "rustup component add rustfmt --toolchain 1.95.0"
  end
